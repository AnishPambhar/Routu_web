        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-heading font-bold text-xl">Routo</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Turn your daily commute into extra income. Connect riders, vendors, and customers in a seamless delivery
              ecosystem.
            </p>
  ...
  >
    <Instagram className="h-5 w-5 text-gray-400 hover:text-pink-500 cursor-pointer transition-colors" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Ride & Vendor Delivery</li>
              <li className="text-gray-400">Personal Parcel Service</li>
              <li className="text-gray-400">Pickup & Drop</li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">support@routo.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-green-500" />
                <span className="text-gray-400 text-sm">+91 97375 45084</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 Routo. All rights reserved. |
